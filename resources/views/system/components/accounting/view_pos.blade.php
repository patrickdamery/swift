    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row form-inline">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
            <label for="view-pos-commission-account" class="control-label">@lang('accounting/create_pos.commission_account')</label>
            <input type="text" class="form-control" id="view-pos-commission-account">
          </div>
        </div>
