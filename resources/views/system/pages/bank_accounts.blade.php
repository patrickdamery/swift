...
<section class="content-header">
  <h1>
    @lang('bank_accounts.title')
    <small class="crumb">@lang('bank_accounts.view_account')</small>
  </h1>
  <ol class="breadcrumb">
    <li><i class="fa fa-money"></i> @lang('bank_accounts.title')</li>
    <li class="active crumb">@lang('bank_accounts.view_account')</li>
  </ol>
</section>
    ...
    <div class="tab-content">
        ...
        <div class="row form-inline">
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="form-group">
              <label for="bank-account-code" class="control-label">@lang('bank_accounts.number')</label>
              <input class="form-control" id="bank-account-number">
            </div>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="form-group">
              <label for="bank-account-report-date-range" class="control-label">@lang('bank_accounts.date_range')</label>
          ...
          <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12 sm-top-space">
            <div class="form-group">
              <button type="button" class="btn btn-success" id="bank-accounts-create">
                <i class="fa fa-search"></i> @lang('bank_accounts.search')
              </button>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 sm-top-space md-top-space lg-top-space">
            <div class="form-group">
              <button type="button" class="btn btn-success" id="bank-accounts-transaction">
                <i class="fa fa-bank"></i> @lang('bank_accounts.make_transaction')
              </button>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 sm-top-space md-top-space lg-top-space">
            <div class="form-group">
              <button type="button" class="btn btn-info" id="bank-accounts-create">
                <i class="fa fa-plus"></i> @lang('bank_accounts.create')
              </button>
            </div>
          </div>
        </div>
            ...
            <div class="box">
              <div class="box-body table-responsive no-padding swift-table">
                <table class="table table-hover">
                  <thead>
                    <tr>
                      <th>@lang('bank_accounts.date')</th>
                      <th>@lang('bank_accounts.description')</th>
                      <th>@lang('bank_accounts.type')</th>
                      <th>@lang('bank_accounts.value')</th>
                    </tr>
                  </thead>
                  <tbody>
      ...
      <div class="tab-pane" id="bank-accounts-reports">
        <div class="row form-inline">
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="form-group">
              <label for="bank-account-report-number" class="control-label">@lang('bank_accounts.number')</label>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="form-group">
              <label for="bank-account-report-type" class="control-label">@lang('bank_accounts.report_type')</label>
              <select class="form-control" id="bank-account-report-type">
                <option value="summary">@lang('bank_accounts.summary')</option>
                <option value="detail">@lang('bank_accounts.detail')</option>
              </select>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 lg-top-space md-top-space sm-top-space">
            <div class="form-group">
              <button type="button" class="btn btn-success" id="bank-accounts-generate">
                <i class="fa fa-gears"></i> @lang('bank_accounts.generate')
              </button>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 lg-top-space md-top-space sm-top-space">
            <div class="form-group">
              <button type="button" class="btn btn-info" id="bank-accounts-print">
                <i class="fa fa-print"></i> @lang('bank_accounts.print')
              </button>
            </div>
          </div>
        </div>
                ...
                <table class="table table-hover">
                  <thead>
                    <tr>
                      <th>@lang('bank_accounts.date')</th>
                      <th>@lang('bank_accounts.description')</th>
                      <th>@lang('bank_accounts.credit')</th>
                      <th>@lang('bank_accounts.debit')</th>
                      <th>@lang('bank_accounts.value')</th>
                    </tr>
                  </thead>
                  <tbody>
