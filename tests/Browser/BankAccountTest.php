...
class BankAccountTest extends DuskTestCase
{
   ...
   * @return void
   */
  public function testBlankAccountPage()
  {
      $this->browse(function (Browser $browser) {
        $browser->click('[data-target="#create-bank-account"]')
                ...
                ->click('#create-pos-create')
                ->waitForText('Cuenta de Comisiones no puede dejarse en blanco!')
                ->assertSee('Cuenta de Comisiones no puede dejarse en blanco!')
                ->type('#create-pos-commission-account', '333.1.1')
                ->click('#create-pos-create')
